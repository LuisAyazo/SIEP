  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600">Seleccione cómo desea proporcionar la ficha técnica</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <button
          ...
          className="p-8 border-2 border-gray-300 rounded-lg text-left transition-all hover:border-blue-600 hover:bg-blue-50 group"
        >
        ...
        <button
          ...
          className="p-8 border-2 border-gray-300 rounded-lg text-left transition-all hover:border-green-600 hover:bg-green-50 group"
        >
          <div className="flex flex-col items-center text-center">
