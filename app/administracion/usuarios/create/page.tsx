...
export default function CreateUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (selectedCenters.length === 0) {
      setErrors({
        form: 'Debes seleccionar al menos un centro para el usuario'
      });
      return;
    }
        ...
        >
          <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-amber-50 to-white dark:from-gray-700 dark:to-gray-800">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Crear Nuevo Usuario</h1>
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Complete todos los campos para crear un nuevo usuario en el sistema.</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="col-span-1">
                ...
                >
                  <input
                    ...
                    name="email"
                    id="email"
                    className={`shadow-sm focus:ring-amber-500 focus:border-amber-500 block w-full px-4 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md h-12 text-gray-900 dark:text-white bg-white dark:bg-gray-700 ${errors.email ? 'border-red-300 dark:border-red-600' : ''}`}
                ...
                <div className="relative">
                  ...
                  >
                    <input
                      ...
                      name="password"
                      id="password"
                      className={`shadow-sm focus:ring-amber-500 focus:border-amber-500 block w-full px-4 pr-10 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md h-12 text-gray-900 dark:text-white bg-white dark:bg-gray-700 ${errors.password ? 'border-red-300 dark:border-red-600' : ''}`}
              ...
              <div className="col-span-1">
                ...
                >
                  <input
                    ...
                    id="confirmPassword"
                    className={`shadow-sm focus:ring-amber-500 focus:border-amber-500 block w-full px-4 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md h-12 text-gray-900 dark:text-white bg-white dark:bg-gray-700 ${errors.confirmPassword ? 'border-red-300 dark:border-red-600' : ''}`}
              ...
              <div className="col-span-2">
                ...
                {isLoadingRoles ? (
                  <div className="h-12 bg-gray-100 dark:bg-gray-700 animate-pulse rounded-md"></div>
                ) : (
                  <select
                    id="role"
                    name="role"
                    className="block w-full px-4 pr-10 py-3 h-12 text-base border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    value={formData.role}
                    onChange={handleChange}
