          ...
          <React.Fragment key={path.id || 'root'}>
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-lg transition-colors font-medium ${
                index === 0 
                  ? 'hover:bg-blue-50 dark:hover:bg-gray-700 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300'
      ...
      >
        ...
        <AnimatePresence>
          {isDragging && (
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-12 border-4 border-dashed border-blue-500 dark:border-blue-400">
                <svg className="w-24 h-24 text-blue-500 dark:text-blue-400 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-gray-700 border-2 border-amber-200 dark:border-amber-600 text-amber-700 dark:text-amber-400 rounded-xl hover:bg-amber-50 dark:hover:bg-gray-600 transition-all font-medium shadow-sm hover:shadow"
              >
          ...
          <div className="w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-6 overflow-y-auto">
            ...
            <div className="space-y-3 mb-6">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 text-white shadow-lg">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-12 h-12 bg-white/20 dark:bg-gray-700/50 rounded-lg flex items-center justify-center">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className="w-full text-left px-3 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                  <button
                    ...
                    className={`p-2 rounded-md transition-all ${viewMode === 'grid' ? 'bg-white dark:bg-gray-700 shadow text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
                  >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-md transition-all ${viewMode === 'list' ? 'bg-white dark:bg-gray-700 shadow text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
                  >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex gap-1 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                  <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm font-medium transition-all ${sortBy === 'name' ? 'bg-white dark:bg-gray-700 shadow text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-md text-sm font-medium transition-all ${sortBy === 'date' ? 'bg-white dark:bg-gray-700 shadow text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
              ...
              {loading ? (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium">Cargando documentos...</p>
                  </div>
                </div>
              ) : error ? (
                <div className="flex items-center justify-center h-full">
                      ...
                      >
                        {sortedDocuments.map((doc) => (
                          <motion.div
                            ...
                            className={`group bg-white dark:bg-gray-800 rounded-xl border-2 p-4 cursor-pointer transition-all ${
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                      <table className="w-full">
                        <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                          <tr>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Nombre</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Categoría</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Fecha</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Autor</th>
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">Tamaño</th>
                              ...
                              >
                                ...
                                <td className="px-6 py-4">
                                  <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                                    ...
                                    doc.category === 'Planificación' ? 'bg-pink-100 dark:bg-pink-900 text-pink-700 dark:text-pink-300' :
                                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                                  }`}>
                                    {doc.category}
                                  </span>
                                </td>
                                <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{doc.createdAt}</td>
                                <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{doc.author}</td>
                ...
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No hay documentos</h3>
                  <p className="text-gray-500 dark:text-gray-400 mb-6">Arrastra archivos aquí o haz clic en "Subir Documento"</p>
                  <button
                    onClick={() => {setShowCreateModal(true); setModalType('file')}}
                  ...
                  {modalType === 'directory' ? (
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3 pt-4">
                        <button
                          onClick={() => setShowCreateModal(false)}
                          className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-colors dark:text-white"
                        >
                          Cancelar
                        </button>
                        <button
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        {uploadingFile ? (
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">PDF, Word, Excel (Max 10MB)</p>
                          </div>
                        )}
                        <input 
                          id="fileUpload"
                      ...
                      <button
                        onClick={() => setShowCreateModal(false)}
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-colors dark:text-white"
                      >
                        Cancelar
                      </button>
                    </div>
        ...
        <AnimatePresence>
          {selectedDoc && selectedDoc.type === 'file' && (
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-96 bg-white dark:bg-gray-800 shadow-2xl z-40 overflow-y-auto border-l border-gray-200 dark:border-gray-700"
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">Detalles</h3>
                  <button
                ...
                <div className="text-center mb-6 pb-6 border-b border-gray-200">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-white break-all mb-2">{selectedDoc.name}</h4>
                  <span className={`inline-flex px-3 py-1 text-xs font-medium rounded-full ${
                    ...
                    selectedDoc.category === 'Formularios' ? 'bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300' :
                    'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                  }`}>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Tamaño</p>
                    <p className="text-sm text-gray-900 dark:text-white">{selectedDoc.size}</p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Fecha de creación</p>
                    <p className="text-sm text-gray-900 dark:text-white">{selectedDoc.createdAt}</p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Autor</p>
                    <p className="text-sm text-gray-900 dark:text-white">{selectedDoc.author}</p>
                  </div>
