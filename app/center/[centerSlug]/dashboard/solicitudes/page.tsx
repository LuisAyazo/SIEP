  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => router.push(`/center/${resolvedParams.centerSlug}/dashboard/solicitudes/create`)}
        ...
        <div className="grid gap-4">
          {solicitudes.map((solicitud) => (
            <div
              ...
              onClick={() => router.push(`/center/${resolvedParams.centerSlug}/dashboard/solicitudes/${solicitud.id}`)}
            >
              <div className="flex justify-between items-start mb-4">
